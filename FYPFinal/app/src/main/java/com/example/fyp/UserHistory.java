...
public class UserHistory  extends AppCompatActivity implements MyAdapter.ClickListener {
    ...
    {
        final String eventId = userEventsList.get(position).getEventId();
//        final String userId = Settings.Secure.getString(getApplicationContext().getContentResolver(),Settings.Secure.ANDROID_ID);
        AlertDialog myQuittingDialogBox = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        filterArr.remove(position);
                        adapter.eventList = filterArr;
                        RecyclerView.LayoutManager manager = new LinearLayoutManager(UserHistory.this);

                        rv.setLayoutManager(manager);
                        rv.setAdapter(adapter);
                        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Users-Events");
                        Query userDeleteQuery = ref.orderByChild("eventId").equalTo(eventId);
                        ...
                        userDeleteQuery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                for (DataSnapshot userDeleteSnapshot: dataSnapshot.getChildren()) {
                                    ...
                                    Toast.makeText(UserHistory.this, "Event Deleted Successfully", Toast.LENGTH_LONG).show();
                                }
                            }
