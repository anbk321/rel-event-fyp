...
public class WorkshopEventsList extends AppCompatActivity implements MyAdapter.ClickListener{
            ...
            myRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot postSnapshot: snapshot.getChildren()) {
                        ...
                        if (object.getType().equals("workshops") && object.getRating() == -1)
                        {
        ...
        eventRef.setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                {
                    ...
                    Toast.makeText(WorkshopEventsList.this, "Event added to your Activity", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
                    ...
                    if(eID.equals(eventId)) {
                        child.getRef().child("rating").setValue(rating).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    updateEvent(position,rating);
                                    Toast.makeText(WorkshopEventsList.this, "Rating Updated Successfully", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    }
