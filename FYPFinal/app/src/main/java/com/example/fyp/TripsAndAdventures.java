...
public class TripsAndAdventures extends AppCompatActivity implements MyAdapter.ClickListener{
            ...
            myRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot postSnapshot: snapshot.getChildren()) {
                        ...
                        if (object.getType().equals("trips-adventures") && object.getRating() == -1)
                        {
        ...
        eventRef.setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                {
                    ...
                    Toast.makeText(TripsAndAdventures.this, "Event added to your Activity", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
                    ...
                    if(eID.equals(eventId)) {
                        child.getRef().child("rating").setValue(rating).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    updateEvent(position,rating);
                                    Toast.makeText(TripsAndAdventures.this, "Rating Updated Successfully", Toast.LENGTH_LONG).show();
                                }
                            }
                        });
                    }
