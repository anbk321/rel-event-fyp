...
public class SportEventsList extends AppCompatActivity implements MyAdapter.ClickListener{
...
//                        Log.e("Get time", "" + object.getTime());
                        if (object.getType().equals("sports") && object.getRating() == -1)
                        {
        ...
        eventRef.setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                {
                    ...
                    Toast.makeText(SportEventsList.this, "Event added to your Activity", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
                    ...
                    if(eID.equals(eventId)) {
                        child.getRef().child("rating").setValue(rating).addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                {
                                    updateEvent(position,rating);
                                    Toast.makeText(SportEventsList.this, "Rating Updated Successfully", Toast.LENGTH_LONG).show();
                                }
                            }
                        });;
                    }
